...
programa
	:	 { System.out.println("Começou um programa"); }
		...
		lc=listaComandos EOF
                { System.out.println("Numero de comandos: "+$lc.numComandos); 
...
listaComandos returns [ int numComandos, String ultimoComando ] : cmd=comando { System.out.println("Apareceu um comando do tipo "+$cmd.tipoComando); } lc=listaComandos { $numComandos = $lc.numComandos + 1;}
